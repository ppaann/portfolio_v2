...
import { ImageInArticle } from '@/components';
  ...
  return (
    <div className='container  max-w-5xl mx-auto'>
      ...
      <section id='introduction'>
        <div className='flex flex-col md:flex-row pt-28 pb-28 px-10'>
      ...
      <section id='mywork' className='pb-14'>
        <div
          className='flex flex-col md:flex-row justify-around items-start gap-6'
          id='role-description'
        >
          <div className='w-52 border-t border-gray-700'>
      ...
      <section id='overview' className='border-t border-gray-700 pt-10 pb-7'>
        ...
        <p>
          ...
          the first page of Google search results. Advertisement revenue is not
          showing a profitable trend. The frontend platform being used is no
      ...
      <section
        id='research'
        className='relative w-screen pt-7 bg-purple-100/30 left-1/2 -translate-x-1/2 pb-7'
      >
        <div className='container max-w-5xl mx-auto'>
      ...
      <section id='gettingCloserToUCD' className='container py-7'>
      ...
      <section id='stakeholder'>
        ...
        <p className='my-2'>
          ...
          unappealing. However, removing or moving the ad lower down the page is
          not an option as it is one of our main sources of income and must be
        ...
        <ImageInArticle description='Homepage lofi to hifi design'>
          <div className='flex flex-col md:flex-row h-60 md:h-96 max-w-5xl w-full justify-center gap-6'>
            <div className='w-full md:w-2/5 relative'>
              <Image src='/projects/s24/home_lo.png' alt='Homepage-lofi' fill />
            </div>
            <div className='w-full md:w-2/5 relative'>
              <Image src='/projects/s24/home_hi.png' alt='Homepage-hifi' fill />
            </div>
          </div>
        </ImageInArticle>
        ...
        <div className='flex flex-col md:flex-row gap-6'>
          <div className=' w-full md:w-2/3'>
            ...
            <p>
              ...
              proper spot and frequency, so that it can keep the balance between
        ...
        <ImageInArticle description='The mockups and style guides'>
          <div className='relative w-full h-[500px]'>
            ...
            <div className='absolute h-[450px] w-32 right-0 bottom-0'>
              <Image src='/projects/s24/styleguide.jpg' alt='styleguide' fill />
            </div>
      ...
      <section
        id='recap'
        className='pb-20 relative w-screen pt-7 bg-purple-100/30 left-1/2 -translate-x-1/2 px-32'
      >
        ...
        <p>
          It&apos;s important to always keep the user&apos;s needs and habits in
          mind when making changes to a website or application. In this case, it
          seems like the users had developed a certain behavior and pattern of
          use for the homepage that was disrupted by the sudden change. It might
          be worth considering conducting more user research to identify what
