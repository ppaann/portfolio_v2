...
const Navigation = () => {
  return (
    <header className='sticky top-0 left-0 right-0 z-50 frosted-glass shadow-md transition-all duration-300 ease-in-out bg-white'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16'>
        <div className='flex items-center'>
          <a
            href='/home'
            className='text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-neon-cyan via-neon-blue to-neon-purple animate-gradient-pulse bg-400%'
          >
            Your Name
          </a>
        </div>
        ...
        <div className='flex gap-4'>
          <button
            ...
            className='text-gray-600 dark:text-gray-400 hover:text-neon-purple dark:hover:text-neon-cyan focus:outline-none p-2 rounded-full transition-colors'
            aria-label='Toggle theme'
          >
            <i id='theme-toggle-icon' className='fas fa-moon text-lg'></i>
          </button>
          {/* <button
            id='density-toggle'
